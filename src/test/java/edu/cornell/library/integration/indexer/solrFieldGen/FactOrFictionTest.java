...
public class FactOrFictionTest {
	...
	@Test
	public void testFictionBook() throws ClassNotFoundException, SQLException, IOException {
	...
	@Test
	public void testNonFictionBook() throws ClassNotFoundException, SQLException, IOException {
		MarcRecord rec = new MarcRecord(MarcRecord.RecordType.BIBLIOGRAPHIC);
	...
	public void testJapaneseJournal() throws ClassNotFoundException, SQLException, IOException {
		MarcRecord rec = new MarcRecord(MarcRecord.RecordType.BIBLIOGRAPHIC);
