...
public class GetAllSuppressedMfhdId {
   ...
   public static void main(String[] args) {
     GetAllSuppressedMfhdId app = new GetAllSuppressedMfhdId();
     if (args.length != 1 ) {
   ...
   public void run(String destDir) {
      ...
      try {
         mfhdIdList = getCatalogService().getAllSuppressedMfhdId();
      } catch (Exception e) {
   ...
   public void saveListToFile(List<String> mfhdIdList) throws Exception {
      String fname = "/usr/local/src/integrationlayer/VoyagerExtract/suppressedMfhdid-"+ getDateString() +".txt";
